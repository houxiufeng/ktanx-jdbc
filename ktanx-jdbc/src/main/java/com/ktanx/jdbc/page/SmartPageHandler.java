 ...
 */
public class SmartPageHandler extends SimplePageHandler {
    ...
    public String getCountCommand(String sql, String database) {
        //校验是否支持该sql
        ...
        try {
            ...
            //无法解析的用一般方法返回count语句
            String countSql = super.getCountCommand(sql, database);
