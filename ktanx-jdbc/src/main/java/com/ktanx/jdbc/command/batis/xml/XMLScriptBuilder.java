...
import com.ktanx.jdbc.command.batis.build.DynamicSqlSource;
    ...
    List<SqlNode> parseDynamicTags(XNode node) {
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (child.getNode().getNodeType() == Node.CDATA_SECTION_NODE
                ...
                if (handler == null) {
                    throw new KtanxJdbcException("Unknown element <" + nodeName + "> in SQL statement.");
                }
    ...
    private class ChooseHandler implements NodeHandler {
        ...
        private SqlNode getDefaultSqlNode(List<SqlNode> defaultSqlNodes) {
            ...
            if (defaultSqlNodes.size() == 1) {
                ...
                throw new KtanxJdbcException("Too many default (otherwise) elements in choose statement.");
            }
