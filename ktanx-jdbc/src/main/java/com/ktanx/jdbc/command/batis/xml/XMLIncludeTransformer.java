...
import com.ktanx.jdbc.command.batis.parser.PropertyParser;
...
public class XMLIncludeTransformer {
    ...
    private Node findSqlFragment(String refid) {
        ...
        try {
            ...
            throw new KtanxJdbcException("Could not find SQL statement to include with refid '" + refid + "'", e);
        }
    }
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (n.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if (originalValue != null) {
                    throw new KtanxJdbcException("Variable " + name
